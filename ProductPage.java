...
public class ProductPage extends JPanel{
    ...
    public ProductPage(ArrayList<Product>products,Cart cart){
        ...
        scroll.setBorder(BorderFactory.createCompoundBorder(
                new MatteBorder(1,0,1,0,new Color(230,220,215)),BorderFactory.createEmptyBorder()));
    ...
    private JPanel buildToolbar(){
        ...
        bar.setBorder(BorderFactory.createCompoundBorder(
                new MatteBorder(0,0,1,0,new Color(230,220,215)),new EmptyBorder(12,40,12,40)));
        ...
        search.setBorder(BorderFactory.createCompoundBorder(
                new LineBorder(new Color(210,200,195),1),new EmptyBorder(6,10,6,10)));
        search.setPreferredSize(new Dimension(280,34));
        search.addFocusListener(new FocusAdapter(){
            public void focusGained(FocusEvent e){
                search.setBorder(BorderFactory.createCompoundBorder(
                        new LineBorder(RED_ACCENT,1),new EmptyBorder(6,10,6,10)));
            }
    ...
    private void showCartDialog(){
        if (m_cart.isEmpty()){
            JOptionPane.showMessageDialog(this,"Your cart is empty.\nBrowse products and click Add to Cart!","Your Cart",JOptionPane.INFORMATION_MESSAGE);
            return;
        }
        ...
        cartView.setOnModified(()->subtotalLbl.setText(String.format("Subtotal: $%.2f",cartView.getSubtotal())));
        ...
        clearBtn.addActionListener(e->{
            int ok=JOptionPane.showConfirmDialog(dlg,"Remove all items from cart?","Clear Cart",JOptionPane.YES_NO_OPTION);
