...
public class CartPage extends JPanel{
    ...
    private JPanel buildActionRow(){
        ...
        btnCancel.addActionListener(e->{
            int ok=JOptionPane.showConfirmDialog(this,"Discard your order and close?","Cancel Order",JOptionPane.YES_NO_OPTION);
    ...
    private void clearAll(){
        int ok=JOptionPane.showConfirmDialog(this,"Remove all items from cart?","Clear Cart",JOptionPane.YES_NO_OPTION);
        if (ok==JOptionPane.YES_OPTION){
            m_cart.clear();
            cartTablePanel.syncFromCart();
    ...
    private void placeOrder(){
        if (cartTablePanel.isEmpty()){
            JOptionPane.showMessageDialog(this,"Your cart is empty!","Nothing to order",JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        if (name.isEmpty()||addr.isEmpty()){
            JOptionPane.showMessageDialog(this,"Please fill in name and address.","Missing details",JOptionPane.WARNING_MESSAGE);
            return;
        }

        JOptionPane.showMessageDialog(this,"Order placed for " +name+"!\n"+"Delivering to: " +addr+"\n"+"Estimated time: 30–45 minutes. Enjoy your meal!","Order Confirmed",JOptionPane.INFORMATION_MESSAGE);
    ...
    private Border titledBorder(String title){
        return BorderFactory.createTitledBorder(
                BorderFactory.createLineBorder(new Color(220,220,220),1,true),title,TitledBorder.LEFT,TitledBorder.TOP,new Font("SansSerif",Font.BOLD,12),TEXT_MUTED);
    }
